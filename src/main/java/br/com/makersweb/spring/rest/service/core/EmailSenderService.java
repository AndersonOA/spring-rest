...
public class EmailSenderService implements IEmailSenderService {
	...
	private String mergeTemplate(String templateName, Map<String, Object> data) {
		String encoding = ConstantesUtils.MAIL_ENCODING;
	...
	private void sendEmail(String email, String template, Map<String, Object> myData, String[] copia)
		...
		helper.setFrom(ConstantesUtils.EMAIL_NOREPLY_SENDER);
		helper.setText(message, true);
		helper.setSubject("[" + ConstantesUtils.MAIL_SUBJECT + "] " + myData.get("subject"));
